...
let array = ["potato", "tomato", "camcicum", "cabbage"];
array.pop();
console.log(array);
// Add elements to the beginning using unshift
let array1 = ["potato", "tomato", "camcicum", "cabbage"];
array1.unshift("brinjal");
console.log(array1);
// Remove the first element using shift
let array2 = ["potato", "tomato", "camcicum", "cabbage"];
array2.shift();
console.log(array2);
